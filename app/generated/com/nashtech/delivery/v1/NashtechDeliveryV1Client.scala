 ...
 * User agent: apibuilder app.apibuilder.io/nashtech/delivery/latest/play_2_8_client
 */
...
package com.nashtech.delivery.v1.models {
  ...
  package object json {
    ...
    implicit def jsonReadsDeliveryAddress: play.api.libs.json.Reads[com.nashtech.delivery.v1.models.Address] = {
      for {
    ...
    implicit def jsonWritesDeliveryAddress: play.api.libs.json.Writes[Address] = {
      (obj: com.nashtech.delivery.v1.models.Address) => {
        com.nashtech.delivery.v1.models.json.jsObjectAddress(obj)
      }
    }

    implicit def jsonReadsDeliveryContact: play.api.libs.json.Reads[com.nashtech.delivery.v1.models.Contact] = {
      for {
    ...
    implicit def jsonWritesDeliveryContact: play.api.libs.json.Writes[Contact] = {
      (obj: com.nashtech.delivery.v1.models.Contact) => {
        com.nashtech.delivery.v1.models.json.jsObjectContact(obj)
      }
    }

    implicit def jsonReadsDeliveryDelivery: play.api.libs.json.Reads[com.nashtech.delivery.v1.models.Delivery] = {
      for {
    ...
    def jsObjectDelivery(obj: com.nashtech.delivery.v1.models.Delivery): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        ...
        "origin" -> com.nashtech.delivery.v1.models.json.jsObjectAddress(obj.origin),
        "destination" -> com.nashtech.delivery.v1.models.json.jsObjectAddress(obj.destination),
        "contact_info" -> com.nashtech.delivery.v1.models.json.jsObjectContact(obj.contactInfo)
      )
    }

    implicit def jsonWritesDeliveryDelivery: play.api.libs.json.Writes[Delivery] = {
      (obj: com.nashtech.delivery.v1.models.Delivery) => {
        com.nashtech.delivery.v1.models.json.jsObjectDelivery(obj)
      }
    }

    implicit def jsonReadsDeliveryDeliveryForm: play.api.libs.json.Reads[com.nashtech.delivery.v1.models.DeliveryForm] = {
      for {
        origin <- (__ \ "origin").read[com.nashtech.delivery.v1.models.Address]
        destination <- (__ \ "destination").read[com.nashtech.delivery.v1.models.Address]
        contactInfo <- (__ \ "contact_info").read[com.nashtech.delivery.v1.models.Contact]
    ...
    implicit def jsonWritesDeliveryDeliveryForm: play.api.libs.json.Writes[DeliveryForm] = {
      (obj: com.nashtech.delivery.v1.models.DeliveryForm) => {
        com.nashtech.delivery.v1.models.json.jsObjectDeliveryForm(obj)
      }
    }

    implicit def jsonReadsDeliveryError: play.api.libs.json.Reads[com.nashtech.delivery.v1.models.Error] = {
      for {
    ...
    implicit def jsonWritesDeliveryError: play.api.libs.json.Writes[Error] = {
      (obj: com.nashtech.delivery.v1.models.Error) => {
        com.nashtech.delivery.v1.models.json.jsObjectError(obj)
      }
    }
  }
}
...
package com.nashtech.delivery.v1 {
  ...
  class Client(
    ...
    private val logger = play.api.Logger("com.nashtech.delivery.v1.Client")
